    ...
    <div class="container-fluid"><a class="navbar-brand d-xl-flex justify-content-xl-start"
        ...
        <div
            ...
            <ul class="nav navbar-nav mx-auto">
                <li class="nav-item" role="presentation"><a class="nav-link" href="admin.index.php">home</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link" href="admin.view.php">Dashboard</a></li>
            </ul>
            <ul class="nav navbar-nav ml-auto">
                ...
                if (isset($_SESSION['email'])) {
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="admin.logout.php">LOGOUT</a></li>

                    <?php
                } else {
                    ?>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="admin.login.php">LOGIN</a></li>
